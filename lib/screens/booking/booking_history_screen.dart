...
/// Màn hình lịch sử bookings cho Student
...
class _BookingHistoryScreenState extends State<BookingHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null || user.role != UserRole.student) {
      return Scaffold(
        ...
        body: const Center(child: Text('Chỉ dành cho học viên')),
      );
    }
  ...
  String _getEmptyMessage() {
    switch (_selectedFilter) {
      case 'pending':
        return 'Chưa có lịch đặt nào đang chờ xác nhận';
      case 'accepted':
        return 'Chưa có lịch đặt nào đã được chấp nhận';
      case 'completed':
        return 'Chưa có lịch đặt nào đã hoàn thành';
      case 'cancelled':
        return 'Chưa có lịch đặt nào bị hủy';
      default:
        return 'Chưa có lịch đặt nào';
    }
  }
}
...
class _BookingCard extends StatelessWidget {
  ...
  String _getStatusText() {
    ...
    if (booking.rejectReason != null) return 'Bị từ chối';
